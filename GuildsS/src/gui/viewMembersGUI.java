...
public class viewMembersGUI {
    ...
    public static void main(Player p) {
		...
		File folder2 = new File(guildsPath+"/"+data.guildData.convertGuildNameToGuildFileName.get(data.playerGuildData.getClickedGuildName.get(p.getName())));
