...
import invPage.InvClickEvent;
import lang.guiLang;
import lang.messageLang;
import listener.PchatEvent;
import listener.pCloseInvEvent;
...
public class Core extends JavaPlugin{
	...
	public void onEnable() {						
		...
		ownerName = getConfig().getString("rank.owner");
		managerName = getConfig().getString("rank.manager");
		memberName = getConfig().getString("rank.member");
		
        int pluginId = 11292;
        Metrics metrics = new Metrics(this, pluginId);		
        metrics.addCustomChart(new Metrics.SimplePie("chart_id", () -> "GuildsS"));
	...
	private void registerFiles() {
		...
		File o1=new File("plugins/GuildsS");
		if(!(o1.exists())) {
			o1.mkdir();
		}
		File o2=new File("plugins/GuildsS/guilds");
		if(!(o2.exists())) {
			o2.mkdir();
		}						
	...
	private void loadGUI() {
		...
		new noGuildGUI(this);
		new disbandGUI(this);
		new GuestViewGuildStatsGUI(this);
	}	
