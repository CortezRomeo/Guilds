...
public class messageLang {
	...
	public static String[] leavemessage = new String[]{
			"&7-------------------------------",			
			"       &6&lRỜI GUILD",
			"    &fThời gian: &e%s% giây"	
			};
	...
	public static void register() {
        ...
        langFile.get().addDefault("timeLeft.leave", "&cBạn cần đợi &e%second% giây&c nữa để có thể quyết định rời guild tiếp!");         
        ...
        langFile.get().addDefault("create.cancel", "&4Đã hủy tạo guild!");         
        ...
        langFile.get().addDefault("invite.pIsNotHaveThePower", "&cBạn cần là chủ guild hoặc quản lý guild");        
        ...
        langFile.get().addDefault("leave.PIsOwner", "&cBạn không thể rời guild khi đang là chủ guild");
        ...
        langFile.get().addDefault("manager.add.succes.P", "&aBạn đã cho &e%player% &alên chức quản lý guild!");   
        langFile.get().addDefault("manager.add.succes.T", "&aBạn đã được lên chức quản lý guild bởi &e%player%");
        langFile.get().addDefault("manager.remove.succes.P", "&aBạn đã tước quyền quản lý của &e%player%");   
        langFile.get().addDefault("manager.remove.succes.T", "&cBạn đã bị tước quyền quản lý bởi &e%player%");  
        ...
        langFile.get().addDefault("kick.targetNoGuildYet", "&e%player% &ckhông có guild!");
        langFile.get().addDefault("kick.succes.P", "&fBạn đã đuổi &a%player%&f ra khỏi guild!");
        langFile.get().addDefault("kick.succes.T", "&fBạn đã bị đuổi khỏi guild bởi &a%player% &f(&b%rank%&f)");
        langFile.get().addDefault("leave.PIsOwner", "&cBạn không thể rời guild vì bạn đang là chủ guild, hãy nhường quyền chủ guild cho một người trong guild để có thể rời guild!");
        langFile.get().addDefault("leave.message", leavemessage);
        langFile.get().addDefault("leave.haveRequest", "&cBạn không thể rời guild khi đang có yêu cầu/lời mời");        
        langFile.get().addDefault("leave.accept", "&aRời guild thành công!");
        langFile.get().addDefault("leave.deny", "&4Đã hủy rời guild!");                      
        langFile.get().addDefault("leave.expires", "&cĐã hết thời gian để quyết định rời guild!");
        langFile.get().addDefault("leave.error", "&4Đã xảy ra lỗi trong quá trình rời guild, có thể guild bạn đã bị xóa!");          
        ...
        langFile.get().addDefault("setBoard.succes", "&fBạn đã thay đổi thông báo guild thành: %board%");
        ...
        langFile.get().addDefault("setCustomName.succes", "&fBạn đã thay đổi tên custom của guild thành: %name%");           
