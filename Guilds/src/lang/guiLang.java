...
public class guiLang {
	...
	public static void register() {
		...
		guiFile.get().addDefault("nextPage.id", 5);
		...
		guiFile.get().addDefault("gui.noGuild.title", "&8&lGUILD");
		...
		guiFile.get().addDefault("gui.disband.title", "&8Xóa guild (%seconds%)");
		...
		guiFile.get().addDefault("gui.listGuild.title", "&8&lLIST GUILD");
		...
		guiFile.get().addDefault("gui.GuestViewGuildInfo.title", "&8&lTHÔNG TIN GUILD &7(&9%guildName%&7)");
		...
		guiFile.get().addDefault("gui.GuestViewGuildInfo.items.back.type", "customhead");		
		guiFile.get().addDefault("gui.GuestViewGuildInfo.items.back.value",
		"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYmQ2OWUwNmU1ZGFkZmQ4NGU1ZjNkMWMyMTA2M2YyNTUzYjJmYTk0NWVlMWQ0ZDcxNTJmZGM1NDI1YmMxMmE5In19fQ==");
		guiFile.get().addDefault("gui.GuestViewGuildInfo.items.back.id",1);
		guiFile.get().addDefault("gui.GuestViewGuildInfo.items.back.name", "&cTrở về");
		guiFile.get().addDefault("gui.GuestViewGuildInfo.items.back.slot", 22);	
		guiFile.get().addDefault("gui.GuestViewGuildInfo.items.back.lore", back);				
			
		// -------------
			
		guiFile.get().addDefault("gui.viewMembers.rows", 4);
		guiFile.get().addDefault("gui.viewMembers.title", "&8&lXEM THÀNH VIÊN");
