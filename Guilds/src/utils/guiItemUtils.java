			...
			for (String string : createLore) {
				...
				if (replace.equals("guildStats")) {
					...
					String dateString = utils.dateUtils
							.main(Integer.valueOf(data.guildData.getfoundedTime.get(guildName)));

					string = string.replace("%chuSoHuu%", data.guildData.getChuSoHuu.get(guildName));
					string = string.replace("%totalMembers%",
							String.valueOf(data.guildData.gettotalMembers.get(guildName)));
				...
				if (replace.equals("memberStats")) {
					...
					String dateString = utils.dateUtils.main(data.playerGuildData.getJoinGuildDate.get(target));
